...
while continua:
    ...
    numero_pais = {1: 'Brasil',2 : 'França', 3 : 'Aústralia', 4 : 'Rússia', 5 : 'Japão' }
    print('1 = Brasil\n2 = França\n3 = Aústralia\n4 = Rússia\n5 = Japão')
    jogador_num = (input('qual o numero do pais que tu queres jogar? ')) #o jogador diz o número do país q ele quer jogar
    while jogador_num not in ['1','2','3','4', '5']:
        jogador_num = (input('Por favor selecione um némero válido '))
    jogador_num = int(jogador_num)
    ...
    if aleatorio_computador: #se aleatorio_computador for verdade ele cai aqui e escolhe aleatoriamente
        ...
        print('1 = Brasil\n2 = França\n3 = Aústralia\n4 = Rússia\n5 = Japão')
        computador_num = (input('qual o numero do pais que tu queres jogar contra? '))
        while (computador_num not in ['1','2','3','4', '5']) or computador_num == str(jogador_num):
            if computador_num == str(jogador_num):
                computador_num = (input('esse país já está sendo usado, digite outro: '))
                continue
            computador_num = (input('Por favor selecione um némero válido '))
        computador_num = int(computador_num)

        computador = numero_pais[computador_num]
    # selecionando tamanho do mapa
    tamanho_mapa_aleatorio = False
    size = None
    escolha_de_dimensao = input('Você quer escolher a dimensão do seu mapa? Caso não, digite [N]: ')
